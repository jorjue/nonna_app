...
const generateBathListButton = document.getElementById('generateBathListButton');
const bathPreviewList = document.getElementById('bathPreviewList');
const generatePrintTargetButton = document.getElementById('generatePrintTargetButton');
...
generatePrintTargetButton.addEventListener('click', () => {
    ...
    const printTargetUsers = Array.from(selectedCheckboxes).map((checkbox) => {
